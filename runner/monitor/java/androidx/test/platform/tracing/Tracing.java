...
public final class Tracing {
   ...
   *
   * @param tracer A Tracer object. A null reference or a previously registered instance is ignored.
   */
  public void registerTracer(Tracer tracer) {
    if (tracer != null && !tracers.contains(tracer)) {
      tracers.add(tracer);
    }
  }
  ...
  class TracerSpan implements Span {
    ...
    private TracerSpan(Map<Tracer, Span> spans) {
      this.spans = spans;
    }
